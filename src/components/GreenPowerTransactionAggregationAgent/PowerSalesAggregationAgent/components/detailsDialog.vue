<template>
    <el-dialog title="聚合体详情" :visible.sync="detailsDialog" width=60% :close-on-click-modal="false"
        ...
        <div class="visibleDiv">
            <div class="visibleDivSelect">
                <el-descriptions :column="1" border direction="horizontal">
                    <el-descriptions-item label="-光伏主体"   :labelStyle="{'color': '#3C937E','font-weight':'bold'}">{{ details.gfzt}}</el-descriptions-item>
                    <el-descriptions-item label="-聚合体名称"   :labelStyle="{'color': '#3C937E','font-weight':'bold'}">{{ details.jhtmc}}</el-descriptions-item>
                    <el-descriptions-item label="-主机装机容量"  :labelStyle="{'color': '#3C937E','font-weight':'bold'}">{{ details.zjzjrl}}</el-descriptions-item>
                    <el-descriptions-item label="-聚合体装机容量"   :labelStyle="{'color': '#3C937E','font-weight':'bold'}">{{ details.jhtzjrl}}</el-descriptions-item>
                    <el-descriptions-item label="-单元体个数"   :labelStyle="{'color': '#3C937E','font-weight':'bold'}">{{ details.dytgs}}</el-descriptions-item>
                    <el-descriptions-item label="-可招募单元体个数"   :labelStyle="{'color': '#3C937E','font-weight':'bold'}">{{ details.kzmdytgs}}</el-descriptions-item>
                </el-descriptions>
            </div>
            <div class="visibleTable">
                <el-table class="tb-edit" :data="tableData"
                    ...
                    <el-table-column label="合约情况" prop="hyqk" align="center">
                        <template slot-scope="scope">
                            <div v-if="scope.row.hyqk==='1'" style="width:100%;height:100%;display: flex;align-items: center;justify-content: flex-start">
                            ...
                            <div v-if="scope.row.hyqk==='2'" style="width:100%;height:100%;display: flex;align-items: center;justify-content: flex-start">
