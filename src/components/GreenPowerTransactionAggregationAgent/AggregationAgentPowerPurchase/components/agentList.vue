    ...
    <div class="visibleDiv">
        ...
        <div class="visibleTable">
            <el-table class="tb-edit" :data="tableData"
                ...
                <el-table-column label="企业主体" prop="lzbh" align="center" width="150"></el-table-column>
                ...
                <el-table-column label="当前总需求负荷" prop="cydw" align="center"></el-table-column>
                <el-table-column label="缺口负荷" prop="cydw" align="center"></el-table-column>
            </el-table>
        </div>
    </div>
</template>
