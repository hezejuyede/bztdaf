    ...
    <div class="visibleDiv">
        ...
        <div class="visibleTable">
            <el-table class="tb-edit" :data="tableData"
                ...
                <el-table-column label="企业需求总电量" prop="time" align="center"></el-table-column>
                <el-table-column label="已购电量" prop="fddw" align="center" width="70"></el-table-column>
                <el-table-column label="需求电量" prop="cydw" align="center" width="70"></el-table-column>
                <el-table-column label="电量缺口占比" prop="cydw" align="center"></el-table-column>
